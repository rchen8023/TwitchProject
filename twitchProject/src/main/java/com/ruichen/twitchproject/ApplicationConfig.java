...
//set up the configuration of the entire server, project
@Configuration
...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.ruichen.twitchproject.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "laiproject-instance.cj98vhefdobk.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "sonyachen704";
